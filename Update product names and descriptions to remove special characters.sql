...
UPDATE products_description AS pd SET pd.products_name=REPLACE(pd.products_name, '®', '&reg;'), pd.products_description=REPLACE(pd.products_description, '®', '&reg;'), pd.products_measurements=REPLACE(pd.products_measurements, '®', '&reg;'), pd.products_head_title_tag=REPLACE(pd.products_head_title_tag, '®', '&reg;');
...
UPDATE products_description AS pd SET pd.products_name=REPLACE(pd.products_name, '’', "'"), pd.products_description=REPLACE(pd.products_description, '’', "'"), pd.products_measurements=REPLACE(pd.products_measurements, '’', "'");
UPDATE products_description AS pd SET pd.products_name=REPLACE(pd.products_name, '`', "'"), pd.products_description=REPLACE(pd.products_description, '`', "'"), pd.products_measurements=REPLACE(pd.products_measurements, '`', "'");
UPDATE products_description AS pd SET pd.products_name=REPLACE(pd.products_name, 'â€&trade;', "'"), pd.products_description=REPLACE(pd.products_description, 'â€&trade;', "'"), pd.products_measurements=REPLACE(pd.products_measurements, 'â€&trade;', "'");
...
UPDATE products AS p SET p.products_features=REPLACE(p.products_features, 'â€&trade;', "'");
...
UPDATE categories_description AS cd
SET cd.categories_name = REPLACE(cd.categories_name, 'â€&trade;', "'"), 
	cd.categories_description = REPLACE(cd.categories_description, 'â€&trade;', "'"),
	cd.categories_description2 = REPLACE(cd.categories_description2, 'â€&trade;', "'"),
	cd.categories_heading_title = REPLACE(cd.categories_heading_title, 'â€&trade;', "'");
